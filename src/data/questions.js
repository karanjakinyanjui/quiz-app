const questions = [
  ...
  },
  {
    ...
    answers: ["Amazon ElastiCache.", "DynamoDB.", "Simple Storage Service."],
    choices: [
      "Amazon ElastiCache.",
  ...
  },
  {
    ...
    answers: ["Enable the multi-value headers on the ALB."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Write to the backend first and invalidate the cache."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Server-side encryption with AWS KMS-managed keys."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Sam init.", "Sam deploySam publish."],
    choices: [
      "Sam init.",
      "Sam validate.",
      "Sam build.",
  ...
  },
  {
    ...
    answers: ["Rolling with additional batch."],
    choices: [
      "All at once.",
      "Rolling.",
  ...
  },
  {
    ...
    answers: ["Cache the file in the /tmp directory."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Create a mapping template."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Investigate the change sets."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Use an approval action in a stage."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Implement Amazon ElastiCache Redis in Cluster Mode."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Enable server-side encryption in Kinesis Streams."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Amazon Cognito."],
    choices: ["AWS Lambda.", "Amazon Cognito.", "AWS IAM.", "Amazon EC2."],
    multiple: false,
  },
  {
    question:
    ...
    answers: ["A Custom Amazon CloudWatch metric for concurrent users."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Amazon Cognito with unauthenticated access enabled."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Break the function into multiple smaller Lambda functions."],
    choices: [
  ...
  },
  {
    ...
    answers: ["In an Amazon DynamoDB table."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Retry the failed read requests with exponential backoff."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Taking advantage of connection re-use."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Use the AWS CLI to get the metrics."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Amazon Kinesis Streams."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Amazon Kinesis Firehose."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Configure each message with unique MessageGroupIds."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Use environment variables for the Lambda functions."],
    choices: [
  ...
  },
  {
    ...
    answers: ["reviewID."],
    choices: ["starRating.", "reviewID.", "comment.", "productID."],
    multiple: false,
  },
  {
    question:
    ...
    answers: ["Use IAM policy condition."],
    choices: [
  ...
  },
  {
    ...
    answers: ["AWS IAM with MFA enabled."],
    choices: [
  ...
  },
  {
    ...
    answers: ["S3 replication was enabled on the bucket."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Configure an ECS task IAM role for the application to use."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Check AWS CloudTrail for a DeleteBucket event."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Lambda will scale out to execute the requests concurrently."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Add Global Secondary Indexes for trading data."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Use AWS CloudFormation package then CloudFormation deploy."],
    choices: [
  ...
  },
  {
    ...
    answers: ["An IAM managed policy is being used on the IAM role."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Use client-side encryption with customer master keys."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Perform an Elastic Beanstalk Rolling deployment."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Amazon DynamoDB transactions."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Increase the Amazon SQS queue polling timeout."],
    choices: [
  ...
  },
  {
    ...
    answers: ["The EC2 instance will only be able to list the S3 buckets."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Set Retention to Retain source bundle in S3."],
    choices: [
  ...
  },
  {
    ...
    answers: ["API Gateway resource policies."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Replicate the existing MongoDB workload to Amazon DynamoDB."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Set ConsistentRead to true when calling Getltem."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Amazon Kinesis Data Streams with AWS Lambda."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Add a read replica instance."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Create a testing branch in AWS CodeCommit to run unit tests."],
    choices: [
  ...
  },
  {
    ...
    answers: ["AWS CodeCommit."],
    choices: ["AWS CodeBuild.", "Amazon S3.", "AWS CodeCommit.", "AWS Cloud9."],
    multiple: false,
  },
  {
    question:
  ...
  },
  {
    ...
    answers: ["The permissions to invoke the Lambda function are missing."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Amazon Cognito user pools."],
    choices: [
      "AWS AppSync.",
  ...
  },
  {
    ...
    answers: ["The Developer needs to use the put-metric-data command."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Store the connection string in AWS KMS."],
    choices: [
  ...
  },
  {
    ...
    answers: ["SSE with AWS Secrets Manager."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Turn on sticky sessions in the Application Load Balancer."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Increase the available memory to the function."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Roll back the Lambda function to the previous version."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Amazon Cognito.", "Amazon EBS."],
    choices: [
      "Amazon DynamoDB.",
      "Amazon Cognito.",
      "Amazon ElastiCache.",
  ...
  },
  {
    ...
    answers: ["dynamodb:UpdateItem dynamodb:GetItem dynamodb:PutItem."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Server-side encryption with AWS KMS managed keys (SSE-KMS)."],
    choices: [
      "Server-side encryption with Amazon S3 managed keys (SSE-S3).",
      "Server-side encryption with AWS KMS managed keys (SSE-KMS).",
  ...
  },
  {
    ...
    answers: ["Deploy the function using Lambda layers."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Use Amazon CloudWatch Events to send the processed data."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Import a custom key into AWS KMS with annual rotation enabled."],
    choices: [
  ...
  },
  {
    ...
    answers: ["A set of Git credentials generated from IAM."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Assign an Elastic IP address to the fourth instance."],
    choices: [
  ...
  },
  {
    ...
    answers: ["30 seconds."],
    choices: ["0 seconds.", "1 hour.", "1 day.", "forever.", "30 seconds."],
    multiple: false,
  },
  {
    question:
  ...
  },
  {
    ...
    answers: ["x-amz-server-side-encryption."],
    choices: [
      "x-amz-storage-class.",
      "Content-MD5.",
  ...
  },
  {
    ...
    answers: ["Subject.", "Destination.", "Message."],
    choices: [
      "TopicAm.",
      "Subject.",
      "Destination.",
  ...
  },
  {
    ...
    answers: ["Query the local instance metadata."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Define a range index on the table."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Use an encrypted file system on top of the BBS volume."],
    choices: [
  ...
  },
  {
    ...
    answers: ["HTTP.", "SMS."],
    choices: ["HTTP.", "UDP.", "SMS.", "DynamoDB.", "Named Pipes."],
    multiple: true,
  },
  {
    question:
  ...
  },
  {
    ...
    answers: ["User ID, where the application has many different users."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Amazon EBS-backed instances can be stopped and restarted."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Auto Scaling.", "CloudFormation."],
    choices: [
      "Simple Storage Service.",
  ...
  },
  {
    ...
    answers: ["Use the multi-part upload API for this object."],
    choices: [
  ...
  },
  {
    ...
    answers: ["PHP.", "Java."],
    choices: ["Perl.", "PHP.", "Pascal.", "Java.", "SQL."],
    multiple: true,
  },
  {
    question:
    ...
    answers: ["10 write capacity units."],
    choices: [
  ...
  },
  {
    ...
    answers: ["4xx HTTP response code."],
    choices: [
  ...
  },
  {
    ...
    answers: ["myawsbucket.s3-website-ap-northeast-1.amazonaws.com"],
    choices: [
  ...
  },
  {
    ...
    answers: ["Delete the table and create a new table per hour."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Use ElastiCache to save session state."],
    choices: [
  ...
  },
  {
    ...
    answers: ["You're exceeding your capacity on a particular Hash Key."],
    choices: [
  ...
  },
  {
    ...
    answers: ["HH-DD-MM-YYYY-log_instancelD."],
    choices: [
      "Sequential.",
  ...
  },
  {
    ...
    answers: ["Advanced Encryption Standard."],
    choices: [
      "Triple DES.",
  ...
  },
  {
    ...
    answers: ["Add annotations to the segment document and the code."],
    choices: [
  ...
  },
  {
    ...
    answers: ['"codecommit:CreateBranch" "codecommit:DeleteBranch".'],
    choices: [
  ...
  },
  {
    ...
    answers: ["AWS Systems Manager Parameter Store.", "AWS KMS."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Use Amazon CloudFront with signed URLs for Amazon S3."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Add exponential backoff to the application logic."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Store the session state in Amazon ElastiCache."],
    choices: [
  ...
  },
  {
    ...
    answers: ["An AWS serverless application model."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Use AWS X-Ray, then examine the segments and errors."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Properties."],
    choices: ["Conditions.", "Globals.", "Transform.", "Properties."],
    multiple: false,
  },
  {
    question:
  ...
  },
  {
    ...
    answers: ["An Amazon ElastiCache for Redis cluster."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Rename the file to a .config extension."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Use Cognito federated identities."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Use Amazon Cognito with web identity federation."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Use DeleteItem using a ConditionExpression."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Amazon S3 and Amazon CloudFront."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Amazon Cognito identity pools and AWS IAM."],
    choices: [
  ...
  },
  {
    ...
    answers: ["An Amazon ECS task definition."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Use AWS root user to make requests to the application."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Immutable."],
    choices: ["All at once.", "Rolling.", "Snapshots.", "Immutable."],
    multiple: false,
  },
  {
    question:
    ...
    answers: ["Use Amazon RDS as a custom origin for Amazon CloudFront."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Read: 6 read capacity unitsWrite: 70 write capacity units."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Call the update-function-code API."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Turn on S3 default encryption for the S3 bucket."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Mappings."],
    choices: ["Parameters.", "Outputs.", "Mappings.", "Resources."],
    multiple: false,
  },
  {
    question:
    ...
    answers: ["Query operation using eventually-consistent reads."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Modify the function runtime to include the necessary library."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Amazon DynamoDB Accelerator."],
    choices: [
      "Amazon EMR.",
      "Amazon DynamoDB Accelerator.",
      "Amazon SQS.",
  ...
  },
  {
    ...
    answers: ["Amazon DynamoDB."],
    choices: ["Amazon DynamoDB.", "Amazon EC2.", "AWS Lambda.", "Amazon RDS."],
    multiple: false,
  },
  {
    question:
  ...
  },
  {
    ...
    answers: ["Use nested stacks for common template patterns."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Implement exponential backoffs in the application."],
    choices: [
      "Implement exponential backoffs in the application.",
  ...
  },
  {
    ...
    answers: ["Upload the object using the multi-part upload API."],
    choices: [
  ...
  },
  {
    ...
    answers: ["200 read capacity units."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Write data to Amazon ElastiCache."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Change the deployment policy to disassociate the database."],
    choices: [
  ...
  },
  {
    ...
    answers: ["Amazon EC2, Amazon Aurora."],
    choices: [
  ...
  },
  {
    ...
    answers: ["The aws executable is not in the PATH environment variable."],
    choices: [
  ...
  },
  {
    ...
    answers: ["In the .ebextensions folder."],
    choices: [
